...
import {toggleLight} from "../../Redux/MainSlice";
...
const Header: FC = () => {
    ...
    return <header className={isLight ? css.light : ''}>
        ...
        <div onClick={ToggleLight}>
            {isLight ?
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="orange"
                     className="bi bi-brightness-high-fill text-sun" viewBox="0 0 16 16">
                    <path
